...
#    L=10
    ...
    plt.plot(df_VCR1['TEMP'], df_VCR1['C']*1e12,"s",markersize=1, color='r', label='Vb=0')
    ...
    titlename="Number "+ str(iter+1) +  " " +  Device_name +  " "+ "W=" + str(W) + " " + "L=" + str(L) + " " + "M=" + str(M) + "MIMCAP vs Temp"
    ...
    plt.plot(df_VCR1['TEMP'], df_VCR1['C']/cap_at_zero_meas,"s",markersize=1, color='r', label='Vb=0 Silicon')
    ...
    titlename=  "Number "+ str(iter+1) +  " " +  Device_name +  "  " + "W=" + str(W) + " " + "L=" + str(L) + " " + "M=" + str(M) + "_MIMCAP vs Temp Coefficients"
