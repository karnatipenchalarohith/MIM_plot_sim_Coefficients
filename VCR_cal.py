...
#    L=10
    ...
    titlename=  "Number "+ str(iter+1)  + " " +  Device_name + "  " + "W=" + str(W) + " " + "L=" + str(L) + " " + "M=" + str(M) + "_MIMCAP vs Voltage"
    ...
    titlename=  "Number " + str(iter+1) + " " +  Device_name + " " + "  " + "W=" + str(W) + " " + "L=" + str(L) + " " + "M=" + str(M) + "_MIMCAP vs Voltage Coefficients"
