...
# -*- coding: utf-8 -*-
"""
Created on Thu Oct 20 09:25:58 2022
...
filename= Device_name + '_p200.txt'
...
#    L=10
    ...
    plt.plot(df_VCR1['V'], df_VCR1['C']*1e12,"s",markersize=1, color='r', label='Vb=0 Silicon')
    
    
    plt.plot(df_sim['vg'], df_sim['capacitance']*1e12, color='g', label='Vb=0 TT')
    
    plt.plot(df_sim_ss['vg'], df_sim_ss['capacitance']*1e12, color='c', label='Vb=0 SS')
    
    plt.plot(df_sim_ff['vg'], df_sim_ff['capacitance']*1e12, color='m', label='Vb=0 FF')
    
    
    
    titlename=  "Number "+ str(iter+1)  + " " +  Device_name + "  " + "W=" + str(W) + " " + "L=" + str(L) + " " + "M=" + str(M) + "_MIMCAP vs Voltage" + " Temp=" + str(temperature)
    ...
    ab=plt.figure()
    plt.plot(df_VCR1['V'], df_VCR1['C']/cap_at_zero_meas,"s",markersize=1, color='r', label='Vb=0 Silicon')
    ...
    titlename=  "Number " + str(iter+1) + " " +  Device_name + " " + "  " + "W=" + str(W) + " " + "L=" + str(L) + " " + "M=" + str(M) + "_MIMCAP vs Voltage Coefficients" + " Temp=" + str(temperature)
